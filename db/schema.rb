...
ActiveRecord::Schema.define(version: 20_180_405_125_800) do
  ...
  create_table 'transfers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[transferable_type transferable_id], name: 'index_transfers_on_transferable_type_and_transferable_id'
  end

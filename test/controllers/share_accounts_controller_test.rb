...
class ShareAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share_account" do
    assert_difference('ShareAccount.count') do
      post share_accounts_url, params: { share_account: { compulsory_balance: @share_account.compulsory_balance, compulsory_deposit: @share_account.compulsory_deposit, member_id: @share_account.member_id, number: @share_account.number, share_product_id: @share_account.share_product_id, total_balance: @share_account.total_balance, voluntary_balance: @share_account.voluntary_balance } }
    end
  ...
  test "should update share_account" do
    patch share_account_url(@share_account), params: { share_account: { compulsory_balance: @share_account.compulsory_balance, compulsory_deposit: @share_account.compulsory_deposit, member_id: @share_account.member_id, number: @share_account.number, share_product_id: @share_account.share_product_id, total_balance: @share_account.total_balance, voluntary_balance: @share_account.voluntary_balance } }
